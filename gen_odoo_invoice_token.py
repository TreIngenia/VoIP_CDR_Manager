...
def main():
    ...
    # ESEMPIO 1: Termini di pagamento automatici (del cliente)
    # print("\n📋 ESEMPIO 1: Termini di pagamento automatici")
    # invoice_id = odoo.create_and_confirm_invoice(partner_id=8378, items=items)
    
    # ESEMPIO 2: Forza 60 giorni manualmente
    print("\n📋 ESEMPIO 2: 60 giorni manuali")
    invoice_id = odoo.create_and_confirm_invoice(partner_id=8378, items=items, due_days=60)
    
    # ESEMPIO 3: Data di scadenza specifica
    # print("\n📋 ESEMPIO 3: Data specifica")
    # invoice_id = odoo.create_and_confirm_invoice(partner_id=8378, items=items, manual_due_date='2025-08-15')
    
    # ESEMPIO 4: Data manuale ha priorità su giorni manuali
    # print("\n📋 ESEMPIO 4: Data manuale sovrascrive giorni")
    # invoice_id = odoo.create_and_confirm_invoice(partner_id=8378, items=items, due_days=30, manual_due_date='2025-09-01')
...
if __name__ == '__main__':
    ...
    # Esecuzione normale (completa)
    main()
    
    # Oppure decomenta una di queste righe per altre funzioni:
    
    # Test di tutti gli scenari
    # test_different_scenarios()
    
    # Test specifico per le date
    # test_date_scenarios()
    
    # Creazione rapida di una fattura
